...
const dateNow = () => new Date().toLocaleString("sv-SE", { timeZone: "Asia/Ho_Chi_Minh" })

var dateFormat = new Intl.DateTimeFormat("sv-SE", {
...
$(window).on('load', async () => {
    ...
    async function loggingAndBot() {
        ...
        setTimeout(() => logHistory("LONG", 1300.1, false), 5000)
